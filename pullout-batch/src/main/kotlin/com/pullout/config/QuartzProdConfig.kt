...
/**
 * Prod Quartz.config Setting from quartz-prod.properties
 */
@Profile("prod")
class QuartzProdConfig(
    ...
    private fun quartzProperties(): Properties {
        ...
        propertiesFactoryBean.setLocation(ClassPathResource("quartz-prod.properties"))
